...
pub fn create_hello_message(private_key: &Vec<u8>) -> Vec<u8> {
    ...
    let hello = HelloMessage {
        ...
        capabilities: vec![CapabilityMessage{ name: CapabilityName(ArrayString::from("eth").unwrap()), version: 66}],
...
mod tests {
    ...
    fn test_parsing_eip_tx() {
        ...
        assert_eq!("af9f790423edbdb566b915555ddb4c45b92936232006bca0622f262fa3859704", hex::encode(&t.txid));
    }
    ...
    fn test_parse_type2() {
        ...
        let t = parse_transaction(tx_payload);
        assert_eq!("ed382cb554ad10e94921d263a56c670669d6c380bbdacdbf96fed625b7132a1d", hex::encode(&t.txid));
    }
}