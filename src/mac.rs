...
mod tests {
    ...
    fn test_update_header() {
        let secret =
            hex::decode("128041d7ebcbdcb728bf5c4fc5cd82ec46e789b9bbfab8a38cb81f7dd34a0c4c")
                .unwrap();
    ...
    fn test_keccak256() {
        ...
        assert_eq!(
            lola.to_vec(),
            hex::decode("4a043346b8c9f74d7bd8ba9a60e957c6355fed50423278ff175fa6b7fd42d88c")
                .unwrap()
        );
    }
}
